...
def process_event(event):
    ...
    event_types[touple] = event_types.get(touple,0) + 1
    ...
    if event['event'] == "route update":
        ...
        if visit_status == 'done':
            #notify the user that the visit has been completed
            pass
        ...
        last_visit_is_vehicle_end_location = following_visits[-1]['location']['id'] == vehicle['end_location']['id']
